...
ticket_url = "{}/demandas".format(url_base)
...
payload = {
    "titulo": "Abertura de demanda script Python",
    "descricao": '<p><b>Abertura de demandas</b></p>',
    "categoria": {"categoriaKey": 108},
    "projeto":{"projetoKey": 1},
    "tipoDeTicket": {"tipoDeTicketKey": 2},
    "tipoDePrioridade": {"tipoDePrioridadeKey": 8},
    "solicitantes": [{"usuarioKey": 1, "usuarioKey": 6}]
}
